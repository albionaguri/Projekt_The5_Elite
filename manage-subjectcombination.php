...
if(isset($_GET['acid']))
{
  ...
  if($result){
    mysqli_stmt_bind_param($result, "ii",$acid,$status);
    mysqli_stmt_execute($result);
    $msg="Subject Activate successfully";

  }
}
// per caktivizimin e lendes
if(isset($_GET['did']))
{
  $did=intval($_GET['did']);
  $status=0;
  ...
  $result = mysqli_prepare($con, $sql);
  if($result){
    mysqli_stmt_bind_param($result, "ii",$did,$status);
    mysqli_stmt_execute($result);
                    ...
                    <?php if($msg){?>
                      ...
                      <div class="panel-body p-20">
                        ...
                        <table id="example" class="display table table-striped table-bordered" cellspacing="0" width="100%">
                          ...
                          <tbody>
                            <?php
                            $sql = "SELECT tblclasses.ClassName,tblclasses.Section,tblsubjects.SubjectName,
                            tblsubjectcombination.id as scid,tblsubjectcombination.status
                              ...
                              {   ?>
                                <tr>
                                  ...
                                  <td>
                                    <?php if($stts=='0')
                                    { ?>
                                      <a href="manage-subjectcombination.php?acid=<?php echo htmlentities($row["scid"]);?>"
                                         onclick="confirm('Are you sure you want to activate this subject');">
                                         <i class="fa fa-check" title="Activate Record"></i>
                                      </a><?php }
                                      else {?>

                                        <a href="manage-subjectcombination.php?did=<?php echo htmlentities($row["scid"]);?>"
                                          onclick="confirm('Are you sure you want to deactivate this subject');">
                                          <i class="fa fa-times" title="Deactivate Record"></i> </a>
                                      <?php }?>
                                    </td>
                                  </tr>
                                  <?php $cnt=$cnt+1;}} ?>
