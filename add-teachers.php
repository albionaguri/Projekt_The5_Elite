...
if(isset($_POST['submit']))
{
  ...
  if (empty($username) || empty($password) ||  empty($email) || empty($gender) || empty($dob)){
  ...
  if ($nr == 1){
      $_SESSION["ErrorMessage"] = "Username is taken!Please try another one!";
      header("location: add-teachers.php");
      exit;
  }

  $sql="INSERT INTO users(username,email, gender, DOB, role,password)
        VALUES('$username','$email','$gender','$dob', '$roli','$password')";
                    ...
                    <?php if($msg){?>
                      ...
                      <form class="form-horizontal" method="post">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-10">
                            <input type="text" name="username" class="form-control" id="fullname"  autocomplete="off">
                          </div>
                        </div>
