...
$sql="UPDATE  tblsubjects
      SET SubjectName='$subjectname',SubjectCode='$subjectcode' WHERE id=$sid";
            ...
            <label for="default" class="col-sm-2 control-label">Subject Name</label>
              <div class="col-sm-10">
                <input type="text" name="subjectname"
                      value="<?php echo htmlentities($row["SubjectName"]);?>" class="form-control" id="default" placeholder="Subject Name" required="required">
            </div>
          </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="text" name="subjectcode" class="form-control"
                        value="<?php echo htmlentities($row["SubjectCode"]);?>"  id="default" placeholder="Subject Code" required="required">
                </div>
            </div>
                                                    <?php }} ?>
