...
<?php
    ...
    if (isset($_POST["submit"])) {
        ...
        elseif (preg_match('/[^A-Za-z0-9]/', $new_password)){
            ...
            $chngpwd = "UPDATE users SET password  = '$new_password' WHERE username= '$username' AND role = 'Admin'";
            $result = mysqli_query($con, $chngpwd);
...
<head>
  ...
  function valid()
  {
    if(document.chngpwd.new_password.value!= document.chngpwd.new_confirm_password.value)
    {
      alert("New Password and Confirm Password Field do not match  !!");
      document.chngpwd.new_confirm_password.focus();
      return false;
    }
    return true;
  }
                      ...
                      <div class="panel-body">
                        ...
                        <form  name="chngpwd" method="post" \ onSubmit="return valid();">
                          ...
                          <div class="form-group has-success">
                            ...
                            <div class="">
                              <input type="text" name="username"  class="form-control" id="success">
                            </div>
                          </div>
                          <div class="form-group has-success">
                            <label for="success" class="control-label">Current Password</label>
                            <div class="">
                              <input type="password" name="password" class="form-control"  id="success">
                            </div>
                          </div>
                          <div class="form-group has-success">
                            <label for="success" class="control-label">New Password</label>
                            <div class="">
                              <input type="password" name="new_password"  class="form-control" id="success">
                            </div>
                          </div>
                          <div class="form-group has-success">
                            <label for="success" class="control-label">Confirm Password</label>
                            <div class="">
                              <input type="password" name="new_confirm_password" class="form-control" id="success">
                            </div>
                          </div>
                          <div class="form-group has-success">
