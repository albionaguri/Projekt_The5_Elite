                ...
                <div class="panel">
                  ...
                  <div class="panel-body">
                    <?php if($msg){?>
                      ...
                      <?php } ?>
                      <form class="form-horizontal" method="post" action="add-subjectcombination.php">
                          ...
                          <div class="col-sm-10">
                            <select name="class" class="form-control" id="default" required="required">
                              ...
                              if($num_rows > 0)
                              {
                                ...
                                {   ?>
                                  <option value="<?php echo htmlentities($row["id"]); ?>"> <?php echo htmlentities($row["ClassName"]); ?>&nbsp; Section-<?php echo htmlentities($row["Section"]); ?></option>
                                <?php }} ?>
                              </select>
                            </div>
                          </div>
                                ...
                                if($num_rows > 0)
                                {
                                  while($row = mysqli_fetch_array($result))
                                  {
                                    ...
                                    <option value="<?php echo htmlentities($row["id"]); ?>">
                                      <?php echo htmlentities($row["SubjectName"]); ?></option>
                                    <?php }} ?>
                                  </select>
                                </div>
                              </div>
