                              ...
                              {   ?>
                                <tr>
                                  ...
                                  <td>
                                    ...
                                    <a href="edit-class.php?classid=<?php echo htmlentities($row["id"]);?>"><i class="fa fa-edit" title="Edit Record"> Edit</i> </a>
                                  </td>

                                  <td>
                                    <a href="delete-class.php?Delete=<?php echo $row['id']; ?>"><i class="fa fa-edit">  Delete </i></a></td>
